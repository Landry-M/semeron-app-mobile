...
const App: () => Node = () => {
  ...
  PushNotification.localNotificationSchedule({
    ...
    date: new Date(Date.now() + 86400000 - Math.abs((moment().hour() * 60 * 60 * 1000) - 27000000)),
    //repeatType: "day", // (optional) Repeating interval. Check 'Repeating Notifications' section for more info.
    //repeatTime: 86400000 - Math.abs((moment().hour() * 60 * 60 * 1000) - 27000000)
  });
  //PushNotification.cancelLocalNotifications({ id: 0 });

  //heure en milliseconde
  _heure_milliseconde = () => {

    let curDate = new Date();
    let heure_actuel = curDate.getHours()

    //heure actuelle en milliseconde
    let result = 86400000 - Math.abs((heure_actuel * 60 * 60 * 1000) - 27000000)
